    ...
    <div className="w-full pl-4 lg:pl-[330px] bg-white py-4 fixed top-0 right-0 z-30 border-b border-[#E4E7EC]">
      ...
      {show && (
        <Modal
          ...
          description="Are you a property owner? Showcase your property effortlessly with our 'Create a Property' feature. List your property, provide essential details, and attract the right customers in no time!"
          icon={
            <BuildingIcon className=" stroke-[0.8] w-12 h-12 lg:w-14 lg:h-14 text-slate-500" />
          }
          buttons={
            <div className=" flex items-center justify-center flex-wrap gap-2">
              ...
              <Button
                color="error"
                className=" w-28 lg:w-44 justify-center"
                size="sm"
                onClick={() => setShow(false)}
              >
                {" "}
