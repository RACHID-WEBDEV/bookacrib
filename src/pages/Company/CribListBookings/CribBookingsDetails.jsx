...
const CribBookingsDetails = () => {
  ...
  const { listcribbooking, loadingcribbooking, errorcribbooking } = useSelector(
  ...
  const featureFilter = listcribbooking?.data?.features?.map(
  ...
  const totalPrice = listcribbooking?.data?.price + totalFeaturePrice;

  let discount = listcribbooking?.data?.discount; // 5% discount

  let tax_amount = listcribbooking?.data?.tax_amount;
    ...
    <>
      {loadingcribbooking ? (
        ...
        <section className="bg- xl:pb-[100px] pb-[70px] ">
          <div className=" flex flex-wrap items-center justify-between pb-3">
            <Link to="/crib-owner/transactions/list-bookings">
          ...
          <div className=" flex flex-wrap items-center justify-between pb-4">
            ...
            <div>
              ...
              >
                {listcribbooking?.data?.arrival_status === "pending"
                  ? "Checked In"
                  : listcribbooking?.data?.arrival_status}
              </Button>
            </div>
          </div>
                ...
                <div className="lh-room-details">
                  ...
                  {/* <div className="lh-main-room w-full">
                    <Slider {...settingsFor} ref={sliderForHomeRef}>
                      {listcribbooking?.data?.images?.map((image, imagesIndex) => (
                    ...
                    <Slider {...settingsNav} ref={sliderNavHomeRef}>
                      {listcribbooking?.data?.images?.map(
                  ...
                  <div className=" px-4 pt-1 pb-4 shadow lg:w-[83%]">
                    ...
                    <p className=" text-gray-600 text-sm ">
                      {listcribbooking?.data?.property?.address}
                    </p>
                  </div>
                        ...
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              >
                                {listcribbooking?.data?.user?.first_name}{" "}
                                {listcribbooking?.data?.user?.last_name}{" "}
                              </a>
                            </div>
                          </div>
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {listcribbooking?.data?.user?.phone_number}
                            </div>
                          </div>
                          <div className="flex items-center">
                            <svg
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listcribbooking?.data?.user?.email}
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listcribbooking?.data?.user?.address || "N/A"}
                              </a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {formatDateTime(
                                listcribbooking?.data?.created_at
                              )}
                            </div>
                          </div>
                          <div className="flex items-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1 ">
                              ...
                              <Badge
                                ...
                                color={
                                  listcribbooking?.data?.payment_status ===
                                  "paid"
                                    ? "success"
                                    : "warning"
                                }
                                text={listcribbooking?.data?.payment_status}
                              ></Badge>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              ₦
                              {formatNumber(
                                Number(listcribbooking?.data?.price)
                              )}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {listcribbooking?.data?.adult_count}
                            </div>
                          </div>
                          <div className="flex items-center">
                            {/* <svg
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listcribbooking?.data?.minor_count}
                              </a>
                            </div>
                          </div>
                        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-3 border-b py-6 text-xs">
            ...
            <p className="flex justify-between">
              ...
              <span>{formatDateTime(listcribbooking?.data?.created_at)}</span>
            </p>
            <p className="flex justify-between">
            ...
            <div className="w-20 font-medium sm:w-52 text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="font-medium text-slate-600 dark:text-slate-400">
                  ₦{formatNumber(listcribbooking?.data?.price || 0)}
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div className="text-slate-500 whitespace-nowrap">
                ...
                <div className="font-medium text-slate-600 dark:text-slate-400">
                  <Badge
                    ...
                    //  leftIcon={item?.is_active === true && <DotIcon />}
                    color={
                      listcribbooking?.data?.payment_status === "paid"
                        ? "success"
                        : "warning"
                    }
                    text={listcribbooking?.data?.payment_status}
              ...
              <div className="font-medium text-slate-600 dark:text-slate-400">
                ₦{formatNumber(listcribbooking?.data?.balanceDue || 0)}
              </div>
            </div> */}
              {/* <div className="flex items-center justify-between">
              <div className="text-slate-500 whitespace-nowrap">
              ...
              <div className="font-medium text-slate-600 dark:text-slate-400 uppercase">
                {listcribbooking?.data?.transaction?.payment_status}
              </div>
            </div> */}
            </div>
      ...
      {showModal && (
        <CribCheckinOutApproval
          propertyId={listcribbooking?.data?.uuid}
          setOpenModal={setShowModal}
        />
      )}
    </>
...
export default CribBookingsDetails;
