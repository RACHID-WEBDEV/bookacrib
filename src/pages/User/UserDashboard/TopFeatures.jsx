...
const TopFeatures = ({ data }) => {
  console.log(data);
  const [activeId, setActiveId] = useState("total_paid_today");
      ...
      <div className="relative w-full p-6 pr-10 h-32 rounded-2xl  group bg-white">
        <div className="space-y-3 ">
          <p className="text-gray-700 font-medium text- pt-2">
            {activeId === "total_paid_today" && <span>Today</span>}{" "}
          ...
          <div className="flex items-center justify-between">
            <p className="text-2xl font-bold text-gray-800">
              {activeId === "total_paid_today" &&
                data?.bookings?.total_paid_today}
              ...
              <p
                className={classNames(
                  " font-medium",
                  {
                    "text-green-700":
                      // activeId === "total_paid_today" &&
                      // data?.bookings?.total_paid_today >= 3,
                      (activeId === "total_paid_today" &&
                        data?.bookings?.total_paid_today >= 3) ||
                  ...
                  },
                  {
                    "text-red-700":
                      // activeId === "total_paid_today" &&
                      // data?.bookings?.total_paid_today <= 2,
                      (activeId === "total_paid_today" &&
                        data?.bookings?.total_paid_today <= 2) ||
                      (activeId === "total_bookings" &&
        ...
        <div className="absolute top-8 right-2">
          ...
          >
            <DropdownItem onClick={() => setActiveId("total_paid_today")}>
              <p
                id="total_paid_today"
              ...
              <p
                className={classNames(
                  ...
                  },
                  {
                    "text-red-700":
                      // activeCrib === "total_active" &&
                      // data?.properties?.total_paid_today <= 2,
                      (activeCrib === "total_active" &&
              ...
              <p
                className={classNames(
                  ...
                  },
                  {
                    "text-red-700":
                      // activeCribOwner === "total_active" &&
                      // data?.companies?.total_paid_today <= 2,
                      (activeCribOwner === "total_active" &&
