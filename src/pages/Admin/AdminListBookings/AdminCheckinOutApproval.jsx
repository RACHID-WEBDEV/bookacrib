...
import { fetchAdminListBooking } from "../../../Redux/listBookings/listBookingsThunk";

const AdminCheckinOutApproval = ({ setOpenModal, propertyId }) => {
    ...
    try {
      ...
      if (propertyId) {
        const response = await patchData(
          `bookacrib-api-routes/v1/admin/bookings/update-booking-arrival-status?id=${propertyId}`,
          filteredFormData
        );
        if (
          ...
          dispatch(fetchAdminListBooking(propertyId));
...
export default AdminCheckinOutApproval;
