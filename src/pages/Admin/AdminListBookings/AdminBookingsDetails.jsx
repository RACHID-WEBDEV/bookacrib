...
import { Button } from "../../../components/forms/Button";
import CribCheckinOutApproval from "./AdminCheckinOutApproval";
import {
...
const AdminBookingsDetails = () => {
  ...
  // const [listadminbooking, setlistadminbooking] = useState(null);
  const [loading, setLoading] = useState(false);
  const [showModal, setShowModal] = useState(false);

  const { listadminbooking, loadingadminbooking, erroradminbooking } =
    useSelector((state) => state.listbooking);

  // const [selectedOriginCountry, setSelectedOriginCountry] = useState(null);

  // console.log("listadminbooking:", listadminbooking);

  const bookData = listadminbooking?.data?.cached_booking_data;
  // console.log("bookData:", bookData);

  const handlelistadminbookings = async () => {
    dispatch(fetchAdminListBooking(uuid));
  ...
  const featureFilter = listadminbooking?.data?.features?.map(
  ...
  const totalPrice = listadminbooking?.data?.price + totalFeaturePrice;

  let discount = listadminbooking?.data?.discount; // 5% discount

  let tax_amount = listadminbooking?.data?.tax_amount;
  ...
  return (
    <>
      {loadingadminbooking ? (
        ...
        <ErrorStatus
          message={JSON.stringify(erroradminbooking?.message)}
          statusCode={
            erroradminbooking?.status_code || erroradminbooking?.status
          }
          link="/"
          reload
        />
        ...
        <section className="bg- xl:pb-[100px] pb-[70px] ">
          <div className=" flex flex-wrap items-center justify-between pb-3">
            <Link to="/admin/transactions/list-bookings">
          ...
          <div className=" flex flex-wrap items-center justify-between pb-4">
            <div className="text-lg font-bold group-[.mode--light]:text-gray-800 flex items-center ">
              Booking
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={24}
            ...
            <div>
              <Button
                disabled={
                  listadminbooking?.data?.arrival_status === "checked out"
                }
                className=" capitalize"
                onClick={() => setShowModal(true)}
              >
                {listadminbooking?.data?.arrival_status === "pending"
                  ? "Checked In"
                  : listadminbooking?.data?.arrival_status}
              </Button>
            </div>
          </div>

          {/* <div className=" flex items-center justify-between flex-wrap gap-4 pb-4">
            <p className=" lg:text-2xl font-bold text-gray-900">Book Booking</p>
            <div className="">
                ...
                <div className="lh-room-details">
                  ...
                  {/* <div className="lh-main-room w-full">
                    <Slider {...settingsFor} ref={sliderForHomeRef}>
                      {listadminbooking?.data?.images?.map((image, imagesIndex) => (
                    ...
                    <Slider {...settingsNav} ref={sliderNavHomeRef}>
                      {listadminbooking?.data?.images?.map(
                  ...
                  <div className=" px-4 pt-1 pb-4 shadow lg:w-[83%]">
                    ...
                    <p className=" text-gray-600 text-sm ">
                      {listadminbooking?.data?.property?.address}
                    </p>
                  </div>
                ...
                <div className=" sticky top-[80px]">
                  <div className="flex flex-col p-5 box box--stacked">
                    <div className="flex flex-col gap-5">
                      <div className="border rounded-[0.6rem] border-slate-200/80 dark:border-darkmode-400 relative mt-3">
                        <div className="absolute left-0 px-3 ml-4 -mt-2 text-xs uppercase bg-white text-slate-500 dark:bg-darkmode-600">
                          <div className="-mt-px">Guest Details</div>
                        </div>
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          <div className="flex items-center">
                            <svg
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              className=" w-[18px] h-[18px] mr-2.5 stroke-[1.3] text-slate-500"
                            >
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              >
                                {listadminbooking?.data?.user?.first_name}{" "}
                                {listadminbooking?.data?.user?.last_name}{" "}
                              </a>
                            </div>
                          </div>
                          <div className="flex items-center">
                            <svg
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              className="lucide lucide-calendar w-4 h-4 mr-2.5 stroke-[1.3] text-slate-500"
                            >
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {listadminbooking?.data?.user?.phone_number}
                            </div>
                          </div>
                          <div className="flex items-center">
                            <svg
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listadminbooking?.data?.user?.email}
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listadminbooking?.data?.user?.address || "N/A"}
                              </a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {formatDateTime(
                                listadminbooking?.data?.created_at
                              )}
                            </div>
                          </div>
                          <div className="flex items-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1 ">
                              ...
                              <Badge
                                ...
                                color={
                                  listadminbooking?.data?.payment_status ===
                                  "paid"
                                    ? "success"
                                    : "warning"
                                }
                                text={listadminbooking?.data?.payment_status}
                              ></Badge>
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              ₦
                              {formatNumber(
                                Number(listadminbooking?.data?.price)
                              )}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-5 mt-2.5 flex flex-col gap-5 text-sm text-gray-700">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              {listadminbooking?.data?.adult_count}
                            </div>
                          </div>
                          <div className="flex items-center">
                            {/* <svg
                            ...
                            <div className="flex flex-col flex-wrap w-full sm:items-center sm:flex-row gap-y-1">
                              ...
                              <a href="" className="flex items-center ">
                                {listadminbooking?.data?.minor_count}
                              </a>
                            </div>
                          </div>
                        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-3 border-b py-6 text-xs">
            ...
            <p className="flex justify-between">
              ...
              <span>{formatDateTime(listadminbooking?.data?.created_at)}</span>
            </p>
            <p className="flex justify-between">
            ...
            <div className="w-20 font-medium sm:w-52 text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="font-medium text-slate-600 dark:text-slate-400">
                  ₦{formatNumber(listadminbooking?.data?.price || 0)}
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div className="text-slate-500 whitespace-nowrap">
                ...
                <div className="font-medium text-slate-600 dark:text-slate-400">
                  <Badge
                    ...
                    //  leftIcon={item?.is_active === true && <DotIcon />}
                    color={
                      listadminbooking?.data?.payment_status === "paid"
                        ? "success"
                        : "warning"
                    }
                    text={listadminbooking?.data?.payment_status}
              ...
              <div className="font-medium text-slate-600 dark:text-slate-400">
                ₦{formatNumber(listadminbooking?.data?.balanceDue || 0)}
              </div>
            </div> */}
              {/* <div className="flex items-center justify-between">
              <div className="text-slate-500 whitespace-nowrap">
              ...
              <div className="font-medium text-slate-600 dark:text-slate-400 uppercase">
                {listadminbooking?.data?.transaction?.payment_status}
              </div>
            </div> */}
            </div>
      ...
      {showModal && (
        <CribCheckinOutApproval
          propertyId={listadminbooking?.data?.uuid}
          setOpenModal={setShowModal}
        />
      )}
    </>
...
export default AdminBookingsDetails;
