...
const DetachPermisssionModal = ({ setOpenModal }) => {
  ...
  useEffect(() => {
    setSelectedValue(getDefaultPermissions);
  ...
  console.log("selectedRole:", getDefaultPermissions);
  ...
  const onSubmit = async () => {
    ...
    try {
      const result = await postData(
        "v1/admin/permissions/detach-permissions-from-role?with[]=permissions",
        filteredFormData
      );
                      ...
                      <div className="lg:w-full">
                        ...
                        {getDefaultPermissions.length !== 0 && (
                          <p className=" text-xs text-gray-600 pb-2">
                            <b>Note:</b> Only Permission you want to detach
                            should be left inside the select below before you
                            click on &quot;Detach Permissions&quot;.
                          </p>
                        )}
                        <div className="pb-6">
                          <AsyncReactSelect
                            ...
                            placeholder="Select a permissions to detach from the role selected"
                            label="Permissions"
                            isMulti
                          />
                        </div>
...
export default DetachPermisssionModal;
