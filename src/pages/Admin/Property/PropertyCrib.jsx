...
const PropertyCrib = () => {
  ...
  const navigatePropertyDetail = async (record) => {
    try {
      navigate(`/crib-owner/property/property-detail/${record.uuid}`);
    } catch (error) {
  ...
  const navigatePropertyEdit = async (record) => {
    try {
      navigate(`/crib-owner/property/property-edit/${record.uuid}`);
    } catch (error) {
      console.error("Error navigating:", error);
    }
  };
                        ...
                        <td className="px-6 py-4 ">
                          ...
                          <div className="font-normal  text-gray-600 capitalize ">
                            <div className=" flex items-center gap-3">
                              ...
                              <div className=" flex flex-col gap-px">
                                <p className="text-base text-gray-900 font-medium  w-[400px] truncate">
                                  {" "}
                                  {item?.name}
                                </p>
