...
const ViewCategoryModal = ({ setOpenModal, categoryData }) => {
  // console.log("ctaea : ", categoryData);
  return (
            ...
            <div className=" h-[300px] ">
              <ScrollArea className="h-full">
                ...
                <div className="p-5 space-y-6 text-sm">
                  ...
                  <div className=" space-y-1 flex items-center justify-between flex-wrap">
                    ...
                    <div className="text-gray-900 font-medium">
                      <Badge
                        ...
                        color={
                          categoryData?.is_active === true ? "success" : "error"
                        }
                        text={
                  ...
                  <div className=" space-y-1 flex items-center justify-between flex-wrap">
                    <Label text="Should Show" />
                    <div className="text-gray-900 font-medium">
                      <Badge
                        rounded
                        className="capitalize"
                        color={
                          categoryData?.should_show === true
                            ? "success"
                            : "error"
                        }
                        text={
