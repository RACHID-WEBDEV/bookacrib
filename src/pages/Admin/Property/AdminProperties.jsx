...
const AdminProperties = () => {
  ...
  const { properties, property, loading, error } = useSelector(
  ...
  const fetchPropertyHandler = (url, search) => {
    ...
    dispatch(fetchProperties(fetchUrl));
  };
                          ...
                          <div className="font-normal  text-gray-600 capitalize ">
                            <div className=" flex items-center gap-3">
                              ...
                              item?.images.length > 0 ? (
                                <div className=" ">
                                  <img
                                    className="min-w-[139px] min-h-auto  max-h-[120px] max-w-[140px] object-fill "
                                    src={item?.images[0]}
