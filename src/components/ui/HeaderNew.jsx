      ...
      >
        <div className="container m-auto px-2 md:px-12 lg:px-7">
          <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-2 md:gap-0 relative">
                ...
                >
                  <div
                    ...
                    className={classNames(
                      "m-auto h-0.5 w-6 rounded  transition duration-300",
                      { "rotate-45": openMenu === true },
                      { "bg-white": !position },
                      { "bg-stone-900 dark:bg-gray-300": position }
                    )}
                  />
                  <div
                    aria-hidden="true"
            ...
            <div
              className={classNames(
                "hidden absolute top-full transition translate-y-1 lg:peer-checked:translate-y-0 lg:translate-y-0 left-0 lg:top-0 lg:relative peer-checked:flex w-full   lg:flex lg:flex-row flex-col   flex-wrap justify-end lg:items-center gap-6 p-6 rounded-xl lg:p-1  shadow-md lg:shadow-none lg:gap-0  lg:bg-transparent lg:w-9/12 xl:w-9/12",
                { "bg-white dark:bg-gray-900 ": position },
                { "bg-stone-900 dark:bg-gray-300": !position }
              )}
            >
                  ...
                  {NAVIGATION.map((item, index) => (
                    <li key={index}>
                      <Link
                        to={item.href}
                        className={classNames(
                          "block md:px-4 cursor-pointer transition  hover:text-gray-400",
                          { "text-white": !position },
                          { "text-gray-800": position }
                        )}
                      >
                        <span>{item.name}</span>
                      </Link>
